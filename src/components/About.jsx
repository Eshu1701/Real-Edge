  ...
  return (
    <motion.div initial={{opacity:0,x:200}} transition={{duration:1}} whileInView={{opacity:1,x:0}} viewport={{once:true}}  className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
        ...
        <div className='flex flex-col items-center md:items-center mt-10 text-gray-600'>
          ...
          <p className='my-10 md:w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae repellat, exercitationem obcaecati esse optio impedit. Obcaecati dolor error voluptate? Voluptatem veritatis nulla aspernatur hic at error tempora dolorem magnam esse.</p>
