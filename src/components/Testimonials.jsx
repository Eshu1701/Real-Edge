...
const Testimonials = () => {
  return (
    <motion.div  initial={{opacity:0,y:200}} transition={{duration:1}} whileInView={{opacity:1,x:0}} viewport={{once:true}} className=' container mx-auto py-10 lg:px-32 w-full overflow-hidden' id ='Testimonials'>
        ...
        <p className=' text-centre text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories From those Who Found Home With Us</p>
